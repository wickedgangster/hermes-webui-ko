...
const LOCALES = {
  ...
  ko: {
	...
	offline_stream_waiting: '연결이 끊겼습니다.\n새로고침을 기다리는 중…',
	...
	tree_view: '트리',
	raw_view: '원문',
	parse_failed_note: '파싱 실패',
	you: '나',
	
	mcp_servers_title: 'MCP 서버',
	mcp_servers_desc: 'config.yaml에 설정된 Model Context Protocol 서버를 관리합니다.',
	mcp_no_servers: '설정된 MCP 서버가 없습니다.',
	mcp_add_server: '+ 서버 추가',
	mcp_field_name: '서버 이름',
	mcp_transport_label: '전송 방식',
	mcp_field_command: '명령',
	mcp_field_args: '인수(쉼표로 구분)',
	mcp_field_url: 'URL',
	mcp_field_timeout: '제한 시간(초)',
	mcp_save: '저장',
	mcp_cancel: '취소',
	mcp_name_required: '서버 이름은 필수입니다.',
	mcp_url_required: 'HTTP 전송 방식에는 URL이 필요합니다.',
	mcp_command_required: 'stdio 전송 방식에는 명령이 필요합니다.',
	mcp_saved: 'MCP 서버가 저장되었습니다.',
	mcp_save_failed: 'MCP 서버 저장 실패.',
	mcp_delete_confirm_title: 'MCP 서버 삭제',
	mcp_delete_confirm_message: 'MCP 서버 "{0}"을(를) 삭제할까요? 이 작업은 되돌릴 수 없습니다.',
	mcp_deleted: 'MCP 서버가 삭제되었습니다.',
	mcp_delete_failed: 'MCP 서버 삭제 실패.',
	mcp_load_failed: 'MCP 서버를 불러오지 못했습니다.',
	mcp_restart_hint: '현재 여기에서는 서버 변경 사항을 읽기만 할 수 있습니다.\n변경 사항을 적용하려면 config.yaml을 편집하고 Hermes를 재시작하세요.',
	mcp_toggle_followup: 'MCP 재로드 동작이 명확해질 때까지 활성화/비활성화 제어는 의도적으로 보류되어 있습니다.',
	mcp_status_active: '활성',
	mcp_status_configured: '구성됨',
	mcp_status_disabled: '비활성화됨',
	mcp_status_invalid_config: '잘못된 설정',
	mcp_status_unknown: '알 수 없음',
	mcp_tool_count: '{0}개 도구',
	mcp_enabled_yes: '활성화됨',
	mcp_enabled_no: '비활성화됨',
	mcp_tools_title: 'MCP 도구',
	mcp_tools_desc: '활성 MCP 서버 전체에서 알려진 도구를 검색합니다.',
	mcp_tools_search_placeholder: '도구 이름, 서버 또는 설명으로 검색…',
	mcp_tools_no_tools: '현재 활성 런타임 목록에서 사용할 수 있는 MCP 도구가 없습니다.',
	mcp_tools_no_matches: '검색과 일치하는 MCP 도구가 없습니다.',
	mcp_tools_load_failed: 'MCP 도구를 불러오지 못했습니다.',
	mcp_tools_schema_empty: '스키마 매개변수가 없습니다.',
	mcp_tools_runtime_note: '도구 목록은 이미 알려진 활성 MCP 런타임 데이터만 사용합니다. WebUI는 서버를 시작하거나 탐색하지 않습니다.',
	
	thinking: '생각 중',
	expand_all: '모두 펼치기',
	collapse_all: '모두 접기',
	edit_failed: '편집 실패: ',
	regen_failed: '응답 다시 생성 실패: ',
	reconnect_active: '아직 응답을 생성하는 중입니다.\n준비되면 새로고침할까요?',
	reconnect_finished: '이전에 나갔을 때 응답이 진행 중이었습니다.\n메시지가 업데이트되었을 수 있습니다.',
	...
	queued_label: '응답 후 전송',
	queued_count: (n) => n === 1 ? '1개 대기 중' : `${n}개 대기 중`,
	queued_cancel: '대기 중인 메시지 취소',
	
	model_unavailable: ' (사용 불가)',
	model_unavailable_title: '이 모델은 현재 프로바이더 목록에 더 이상 없습니다.',
	provider_mismatch_warning: (m, p) => `"${m}"은(는) 설정된 프로바이더(${p})에서 작동하지 않을 수 있습니다.\n그대로 보내거나 터미널에서 \`hermes model\`을 실행해 전환하세요.`,
	provider_mismatch_label: '프로바이더 불일치',
	model_not_found_label: '모델을 찾을 수 없음',
	model_custom_label: '사용자 지정 모델 ID',
	model_custom_placeholder: '예: openai/gpt-5.4',
	model_search_placeholder: '모델 검색…',

	session_toolsets: '세션 도구 세트',
	session_toolsets_desc: '이 세션에서 사용할 수 있는 도구를 제한합니다. 비워 두면 전역 설정을 사용합니다.',
	session_toolsets_global: '전역 설정(기본값)',
	session_toolsets_custom: '사용자 지정',
	session_toolsets_placeholder: 'tool1, tool2, …',
	session_toolsets_apply: '적용',
	session_toolsets_clear: '지우기(전역 설정 사용)',
	session_toolsets_applied: '도구 세트가 업데이트되었습니다.',
	session_toolsets_cleared: '도구 세트를 지웠습니다 — 전역 설정을 사용합니다.',
	session_toolsets_failed: '도구 세트 업데이트 실패: ',

	model_search_no_results: '모델을 찾을 수 없습니다',
	...
	cmd_compress: '대화 컨텍스트를 수동으로 압축합니다. 사용법: /compress [집중할 주제]',
	ctx_compress_hint: '컨텍스트를 압축하여 공간 확보 →',
	ctx_compress_action: '⚠ 지금 압축하여 컨텍스트 확보',
	cmd_compact_alias: '/compress의 이전 별칭',
	cmd_model: '모델 전환(예: /model gpt-4o)',
	cmd_workspace: '이름으로 워크스페이스 전환',
	cmd_terminal: '워크스페이스 터미널 열기',
	cmd_new: '새 채팅 세션 시작',
	cmd_usage: '토큰 사용량 표시 켜기/끄기',
	cmd_theme: '외형 전환(theme: system/dark/light, skin: default/ares/mono/slate/poseidon/sisyphus/charizard)',
	cmd_personality: '에이전트 페르소나 전환',
	cmd_skills: '사용 가능한 Hermes 스킬 목록 보기',
	available_commands: '사용 가능한 명령:',
	type_slash: '/ 를 입력해 명령 보기',
	conversation_cleared: '대화를 지웠습니다',
	command_label: '명령',
	context_compaction_label: '컨텍스트 압축',
	preserved_task_list_label: '보존된 작업 목록',
	reference_only_label: '참조 전용',
	model_usage: '사용법: /model ',
	no_model_match: '일치하는 모델 없음: "',
	switched_to: '전환됨: ',
	workspace_usage: '사용법: /workspace ',
	no_workspace_match: '일치하는 워크스페이스 없음: "',
	switched_workspace: '워크스페이스 전환됨: ',
	workspace_switch_failed: '워크스페이스 전환 실패: ',
	new_session: '새 세션을 만들었습니다',
	compressing: '컨텍스트 압축을 요청하는 중...',
	compress_running_label: '압축 중',
	compress_complete_label: '압축 완료',
	auto_compress_label: '자동 압축',
	compress_failed_label: '압축 실패',
	focus_label: '집중 주제',
	...
	cmd_queue: '다음 턴에 보낼 메시지를 대기열에 추가',
	cmd_goal: '지속 목표를 설정하거나 확인',
	goal_evaluating_progress: '목표 진행 상황 평가 중…',
	goal_working_toward: '목표를 향해 작업 중…',
	goal_continuing_toast: '목표 작업을 계속합니다…',
	goal_status_none: '활성 목표가 없습니다.\n/goal 로 설정하세요.',
	goal_status_active: (turns, max_turns, goal) => `⊙ 목표(활성, ${turns}/${max_turns}턴): ${goal}`,
	goal_status_paused: (turns, max_turns, reason, goal) => `⏸ 목표(일시 중지, ${turns}/${max_turns}${reason ? `, ${reason}` : ''}): ${goal}`,
	goal_status_done: (turns, max_turns, goal) => `✓ 목표 완료(${turns}/${max_turns}): ${goal}`,
	goal_set: (turns, goal) => `⊙ 목표 설정됨(${turns}턴 예산): ${goal}`,
	goal_paused: (goal) => `⏸ 목표 일시 중지: ${goal}`,
	goal_resumed: (goal) => `▶ 목표 재개: ${goal}`,
	goal_cleared: '목표가 지워졌습니다.',
	goal_no_goal: '활성 목표가 없습니다.',
	goal_achieved: (reason) => `✓ 목표 달성: ${reason}`,
	goal_paused_budget_exhausted: (turns, max_turns) => `⏸ 목표 일시 중지 — ${turns}/${max_turns}턴을 사용했습니다.\n계속하려면 /goal resume, 중지하려면 /goal clear를 사용하세요.`,
	goal_continuing: (turns, max_turns, reason) => `↻ 목표 작업 계속(${turns}/${max_turns}): ${reason}`,

	cmd_interrupt: '현재 턴을 취소하고 새 메시지 보내기',
	cmd_steer: '에이전트를 중단하지 않고 중간 수정 사항 주입',
	cmd_queue_no_msg: '사용법: /queue ',
	cmd_queue_not_busy: '활성 작업이 없습니다 — 그냥 보내면 됩니다',
	cmd_queue_confirm: '메시지가 대기열에 추가되었습니다',
	cmd_interrupt_no_msg: '사용법: /interrupt ',
	cmd_interrupt_confirm: '중단됨 — 새 메시지를 보냅니다',
	cmd_steer_no_msg: '사용법: /steer ',
	cmd_steer_fallback: '조정을 사용할 수 없어 다음 턴 대기열에 추가했습니다',
	cmd_steer_delivered: '조정 사항이 전달되었습니다 — 다음 도구 결과 후 에이전트가 확인합니다',
	steer_leftover_queued: '조정 사항이 다음 턴 대기열에 추가되었습니다',
	busy_steer_fallback: '조정을 사용할 수 없어 다음 턴 대기열에 추가했습니다',
	busy_interrupt_confirm: '중단됨 — 새 메시지를 보냅니다',

	settings_label_busy_input_mode: '작업 중 입력 방식',
	settings_desc_busy_input_mode: '에이전트가 실행 중일 때 메시지를 보내면 어떻게 처리할지 제어합니다.\n대기는 다음 차례까지 기다리고, 중단은 현재 작업을 취소하고 새로 시작하며, 조정은 현재 작업을 중단하지 않고 중간 수정 사항을 전달합니다(에이전트 또는 스트림을 사용할 수 없으면 대기로 전환).',
	...
	no_personalities: '페르소나를 찾을 수 없습니다. ~/.hermes/personalities/에 추가하세요.',
	available_personalities: '사용 가능한 페르소나:',
	personality_switch_hint: '\n\n전환하려면 `/personality `를 사용하고, 해제하려면 `/personality none`을 사용하세요.',
	personalities_load_failed: '페르소나를 불러오지 못했습니다',
	personality_cleared: '페르소나가 해제되었습니다',
	personality_set: '페르소나: ',
	failed_colon: '실패: ',
	...
	workspace_empty_no_path: '선택된 워크스페이스가 없습니다.\n파일을 탐색하려면 설정 → 워크스페이스에서 워크스페이스를 설정하세요.',
	workspace_empty_dir: '이 워크스페이스는 비어 있습니다.',
	workspace_show_hidden_files: '숨김 파일 표시',
	workspace_show_hidden_files_desc: '.DS_Store, .git, node_modules 및 기타 숨김/시스템 파일을 파일 트리에 포함합니다.',
	workspace_hidden_files_visible: '숨김 파일 표시 중',
	workspace_hidden_files_visible_title: '숨김 파일이 표시 중입니다 — 옵션을 보려면 클릭하세요',
	workspace_options: '워크스페이스 옵션',
	dialog_confirm_title: '작업 확인',
	dialog_prompt_title: '값 입력',
	dialog_confirm_btn: '확인',

	// workspace.js
	unsaved_confirm: '미리보기에 저장되지 않은 변경 사항이 있습니다.\n버리고 이동할까요?',
	discard: '버리기',
	save: '저장',
	edit: '편집',
	clear: '지우기',
	...
	double_click_rename: '두 번 클릭하여 이름 바꾸기',
	renamed_to: '이름 변경됨: ',
	...
	upload_too_large: (maxMb, fileMb) => `파일이 너무 큽니다(${fileMb} MB).\n최대 업로드 크기는 ${maxMb} MB입니다.`,
	all_uploads_failed: (n) => `${n}개 업로드가 모두 실패했습니다`,

	session_pin: '대화 고정',
	session_unpin: '대화 고정 해제',
	session_pin_desc: '이 대화를 맨 위에 유지',
	session_unpin_desc: '고정 목록에서 제거',
	session_pin_failed: '고정 실패: ',
	session_move_project: '프로젝트로 이동',
	session_move_project_desc_has: '이 대화의 프로젝트 변경',
	session_move_project_desc_none: '이 대화에 프로젝트 지정',
	session_archive: '대화 보관',
	session_restore: '대화 복원',
	session_archive_desc: '보관된 항목을 표시할 때까지 이 대화를 숨깁니다',
	session_restore_desc: '이 대화를 기본 목록으로 되돌립니다',
	session_archived: '세션이 보관되었습니다',
	session_restored: '세션이 복원되었습니다',
	session_archive_failed: '보관 실패: ',
	session_duplicate: '대화 복제',
	session_duplicate_desc: '같은 워크스페이스와 모델로 복사본 생성',
	session_duplicated: '세션이 복제되었습니다',
	session_duplicate_failed: '복제 실패: ',
	session_stop_response: '응답 중지',
	session_stop_response_desc: '이 대화에서 실행 중인 응답을 취소합니다',
	session_delete: '대화 삭제',
	session_delete_desc: '이 대화를 영구 삭제합니다',
	...
	settings_updates_available: '{count}개 업데이트 사용 가능',
	settings_updates_disabled: '업데이트 확인 비활성화됨',
	settings_update_check_failed: '업데이트 확인 실패',
	settings_label_workspace_panel_open: '기본으로 워크스페이스 패널 열기',
	settings_desc_workspace_panel_open: '활성화하면 새 세션마다 워크스페이스/파일 브라우저 패널이 자동으로 열립니다.\n언제든지 수동으로 닫을 수 있습니다.',
	...
	settings_desc_session_endless_scroll: '활성화하면 위로 스크롤할 때 이전 메시지를 자동으로 불러옵니다.\n비활성화하면 이전 메시지 버튼을 사용합니다.',
	...
	settings_dropdown_providers: '프로바이더',
	...
	settings_desc_model: '새 대화에 사용됩니다.\n기존 대화는 선택된 모델을 유지합니다.',
	...
	cmd_reasoning: '추론 표시를 전환하거나, 노력 수준을 설정하거나, 현재 상태를 확인합니다',
	...
	kanban_board: '보드',
	kanban_visible_tasks: '{0}개 작업 표시 중',
	kanban_search_tasks: '작업 검색',
	kanban_all_assignees: '모든 담당자',
	kanban_all_tenants: '모든 테넌트',
	kanban_include_archived: '보관된 항목 포함',
	kanban_no_matching_tasks: '일치하는 작업이 없습니다',
	kanban_no_data: '칸반 데이터가 없습니다',
	kanban_work_queue_hint: 'Hermes Agent 작업 대기열입니다.\n작업을 만들거나 분류하고, 담당자를 지정한 뒤 Ready로 옮기면 디스패처가 클레임합니다.',
	kanban_unavailable: '칸반을 사용할 수 없습니다',
	kanban_read_only: '읽기 전용 보기',
	kanban_empty: '비어 있음',
	kanban_task: '작업',
	kanban_no_description: '설명 없음',
	kanban_refresh: '새로고침',
	kanban_status_triage: '분류',
	kanban_status_todo: '할 일',
	kanban_status_ready: '준비됨',
	kanban_status_running: '실행 중',
	kanban_status_blocked: '차단됨',
	kanban_status_done: '완료',
	kanban_status_original_hint: '실제 상태: {0}.\n이 대화상자는 분류/할 일/준비됨 편집만 지원합니다.',
	kanban_comments_count: '댓글({0})',
	kanban_events_count: '이벤트({0})',
	kanban_links: '링크',
	kanban_parents: '상위 항목',
	kanban_children: '하위 항목',
	kanban_runs_count: '실행({0})',
	kanban_no_comments: '댓글 없음',
	kanban_no_events: '이벤트 없음',
	kanban_no_runs: '실행 없음',
	kanban_title: '제목',
	...
	kanban_priority_hint: '높은 숫자가 먼저 실행됩니다.\n기본값: 0.',
	...
	kanban_ready_needs_assignee: '«미할당» + «Ready»를 선택했습니다. 디스패처는 이 작업을 건너뜁니다.\n확인하려면 다시 제출하거나 프로필을 선택하세요.',
	...
	kanban_new_task: '새 작업',
	kanban_add_comment: '댓글 추가',
	kanban_only_mine: '내 것만',
	kanban_bulk_action: '일괄 작업',
	kanban_nudge_dispatcher: '디스패처 미리보기',
	kanban_stats: '통계',
	kanban_worker_log: '워커 로그',
	kanban_block: '차단',
	kanban_unblock: '차단 해제',
	kanban_back_to_board: '보드로 돌아가기',
	kanban_lanes_by_profile: '프로필별 레인',
	kanban_new_board: '새 보드…',
	kanban_rename_board: '현재 보드 이름 바꾸기…',
	kanban_archive_board: '현재 보드 보관…',
	kanban_archive_board_confirm: '"{name}" 보드를 보관할까요? 작업은 디스크에 남으며 kanban/boards/_archived/에서 복원할 수 있습니다.',
	kanban_board_archived: '보드가 보관되었습니다',
	kanban_board_name: '이름',
	kanban_board_slug: '슬러그(소문자, 하이픈)',
	kanban_board_description: '설명(선택)',
	kanban_board_icon: '아이콘(이모지, 선택)',
	kanban_board_color: '색상(선택)',
	kanban_board_name_required: '이름은 필수입니다',
	kanban_board_slug_required: '슬러그는 필수입니다',
	kanban_card_complete: '완료',
	kanban_card_archive: '보관',
	kanban_unassigned: '미할당',
	kanban_status_archived: '보관됨',

	tab_todos: '할 일',
	tab_insights: '통계',
	tab_dashboard: 'Hermes 대시보드',
	dashboard_loopback_warning: '대시보드는 서버에서 loopback 전용입니다.\n서버 자체에서 접속하거나 --host 0.0.0.0(안전하지 않음)으로 다시 시작하세요.',
	tab_logs: '로그',
	tab_settings: '설정',
	...
	logs_status_idle: '최근 줄을 볼 로그 파일을 선택하세요.',
	logs_no_mtime: '아직 기록되지 않음',
	logs_truncated_hint: '큰 로그 파일의 끝부분만 표시 중입니다. 메모리 사용량을 제한하기 위해 오래된 바이트는 건너뛰었습니다.',
	logs_copied: '로그가 복사되었습니다',

	new_conversation: '새 대화',
	filter_conversations: '대화 필터…',
	session_time_unknown: '알 수 없음',
	session_time_minutes_ago: (n) => `${n}분`,
	session_time_hours_ago: (n) => `${n}시간`,
	session_time_days_ago: (n) => `${n}일`,
	session_time_last_week: '1주',
	...
	session_meta_messages: (n) => `${n}개 메시지`,
	session_meta_children: (n) => `${n}개 하위 세션`,
	session_meta_segments: (n) => `${n}개 세그먼트`,
	...
	settings_desc_token_usage: '각 Assistant 응답 아래에 입력/출력 토큰 수를 표시합니다.\n/usage로도 전환할 수 있습니다.',
	...
	settings_auto_title_refresh_5: '5번의 대화마다',
	settings_auto_title_refresh_10: '10번의 대화마다',
	settings_auto_title_refresh_20: '20번의 대화마다',
	settings_desc_auto_title_refresh: '최신 대화를 바탕으로 세션 제목을 자동으로 다시 생성해 대화가 진행되어도 제목을 관련 있게 유지합니다.\nLLM 제목 생성 모델 설정이 필요합니다.',
	...
	settings_desc_password: '새 비밀번호를 설정하거나 변경하려면 입력하세요.\n현재 설정을 유지하려면 비워 두세요.',
	...
	// Providers panel
	providers_tab_title: '프로바이더',
	providers_section_title: '프로바이더',
	providers_section_meta: 'AI 프로바이더의 API 키를 관리합니다.\n변경 사항은 즉시 적용됩니다.',
	providers_status_configured: 'API 키 설정됨',
	providers_status_not_configured: 'API 키 없음',
	providers_status_oauth: 'OAuth',
	providers_status_api_key: 'API 키',
	providers_status_not_configured_label: '설정되지 않음',
	providers_oauth_hint: 'OAuth로 인증되었습니다. API 키가 필요하지 않습니다.',
	providers_oauth_config_yaml_hint: '토큰이 config.yaml을 통해 설정되었습니다.\n업데이트하려면 config.yaml의 providers 섹션을 편집하거나 hermes auth를 실행하세요.',
	providers_oauth_not_configured_hint: '인증되지 않았습니다.\n이 프로바이더를 설정하려면 터미널에서 hermes auth를 실행하세요.',
	providers_save: '저장',
	providers_remove: '제거',
	providers_saving: '저장 중…',
	providers_removing: '제거 중…',
	providers_enter_key: 'API 키를 입력하세요',
	providers_empty: '설정 가능한 프로바이더가 없습니다.',
	providers_key_updated: 'API 키가 저장되었습니다',
	providers_key_removed: 'API 키가 제거되었습니다',
	providers_key_placeholder_new: 'sk-...',
	providers_key_placeholder_replace: '교체할 새 키 입력…',
	...
	onboarding_skipped: '설정을 건너뛰었습니다 — 기존 설정을 사용합니다.',
	onboarding_open: 'Hermes 열기',
	onboarding_step_system_title: '시스템 확인',
	onboarding_step_system_desc: 'Hermes Agent와 설정 접근 가능 여부를 확인합니다.',
	onboarding_step_setup_title: '프로바이더 설정',
	onboarding_step_setup_desc: '최소 Hermes 프로바이더 설정을 저장합니다.',
	onboarding_step_workspace_title: '워크스페이스 + 모델',
	onboarding_step_workspace_desc: '새 세션과 채팅의 기본값을 선택합니다.',
	onboarding_step_password_title: '선택 비밀번호',
	onboarding_step_password_desc: '공유하기 전에 Web UI를 비밀번호로 보호합니다.',
	onboarding_step_finish_title: '마무리',
	onboarding_step_finish_desc: '검토 후 앱으로 들어갑니다.',
	onboarding_notice_system_ready: 'Web UI에서 Hermes Agent에 접근할 수 있는 것으로 보입니다.',
	onboarding_notice_system_unavailable: 'Hermes Agent를 아직 완전히 사용할 수 없습니다.\nBootstrap으로 설치할 수 있지만, 프로바이더 설정에는 여전히 터미널이 필요할 수 있습니다.',
	onboarding_check_agent: 'Hermes Agent',
	onboarding_check_agent_ready: '감지되었고 가져올 수 있음',
	onboarding_check_agent_missing: '없거나 일부만 가져올 수 있음',
	onboarding_check_password: '비밀번호',
	onboarding_check_password_enabled: '이미 활성화됨',
	onboarding_check_password_disabled: '아직 활성화되지 않음',
	onboarding_check_provider: '프로바이더 설정',
	onboarding_check_provider_ready: '채팅 준비됨',
	onboarding_check_provider_partial: '저장되었지만 불완전함',
	onboarding_check_provider_pending: '검증 필요',
	onboarding_config_file: '설정 파일:',
	onboarding_env_file: '.env 파일:',
	onboarding_unknown: '알 수 없음',
	onboarding_current_provider: '현재 설정:',
	onboarding_missing_imports: '누락된 import:',
	onboarding_notice_setup_required: '여기에서 간단한 프로바이더 설정 경로를 선택하세요.\n고급 OAuth 흐름은 당분간 Hermes CLI에서 처리합니다.',
	onboarding_notice_setup_already_ready: '작동 중인 Hermes 프로바이더 설정이 이미 감지되었습니다. 여기에서 유지하거나 교체할 수 있습니다.',
	onboarding_oauth_provider_ready_title: '프로바이더가 이미 인증됨',
	onboarding_oauth_provider_ready_body: '이 인스턴스는 Hermes CLI를 통해 설정된 OAuth 프로바이더({provider})를 사용하도록 구성되어 있습니다.\n여기에서는 API 키가 필요하지 않습니다 — 계속을 눌러 설정을 마치세요.',
	onboarding_oauth_provider_not_ready_title: 'OAuth 프로바이더가 아직 인증되지 않음',
	onboarding_oauth_provider_not_ready_body: '이 인스턴스는 API 키가 아닌 OAuth를 사용하는 {provider}를 쓰도록 구성되어 있습니다.\n터미널에서 `hermes auth` 또는 `hermes model`을 실행해 인증한 뒤 Web UI를 새로고침하세요.',
	onboarding_oauth_switch_hint: '또는 아래에서 다른 프로바이더를 선택해 API 키 방식 설정으로 전환하세요:',
	onboarding_notice_workspace: '이 값들은 일반 앱과 같은 설정 API를 재사용합니다.',
	onboarding_workspace_label: '워크스페이스',
	onboarding_workspace_or_path: '또는 워크스페이스 경로 입력',
	onboarding_workspace_placeholder: '/home/you/workspace',
	onboarding_provider_label: '설정 방식',
	onboarding_quick_setup_badge: '빠른 설정',
	provider_category_easy_start: '쉬운 시작',
	provider_category_self_hosted: '오픈 / 셀프호스팅',
	provider_category_specialized: '특화',
	onboarding_api_key_label: 'API 키',

	oauth_login_codex: 'Codex(ChatGPT)로 로그인',
	oauth_codex_step1: '1단계: 이 URL을 방문해 코드를 입력하세요',
	oauth_codex_step2: '2단계: 페이지에 이 코드를 입력하세요',
	oauth_codex_polling: '인증 대기 중...',
	oauth_codex_success: 'Codex OAuth 로그인 성공!',
	oauth_codex_error: 'OAuth 로그인 실패',
	oauth_codex_expired: '코드가 만료되었습니다. 다시 시도하세요.',

	onboarding_api_key_placeholder: '저장된 기존 키를 유지하려면 비워 두세요',
	onboarding_api_key_label_optional: 'API 키(선택)',
	onboarding_api_key_placeholder_optional: '키가 필요 없는 서버라면 비워 두세요',
	onboarding_api_key_help_keyless: '대부분의 LM Studio / Ollama / vLLM 설치는 키 없이 실행됩니다 — 서버가 인증을 요구하지 않으면 비워 두세요.\n연결 테스트 버튼으로 확인하세요.',
	onboarding_api_key_help_prefix: 'Hermes .env 파일에 secret으로 저장됩니다:',
	onboarding_base_url_label: 'Base URL',
	onboarding_base_url_placeholder: 'https://your-endpoint.example/v1',
	onboarding_base_url_help: 'OpenAI 호환 라우터, 셀프호스팅 서버, LiteLLM, Ollama, LM Studio, vLLM 또는 유사 엔드포인트에 사용합니다.',
	onboarding_model_label: '기본 모델',
	onboarding_workspace_help: '설정 완료 후 새 채팅에 Hermes가 사용할 모델을 선택하세요.',
	onboarding_custom_model_placeholder: 'your-model-name',
	onboarding_custom_model_help: '사용자 지정 엔드포인트의 경우 서버가 요구하는 정확한 모델 ID를 입력하세요.',
	onboarding_notice_password_enabled: '비밀번호가 이미 설정되어 있습니다.\n교체하려는 경우에만 새 비밀번호를 입력하세요.',
	onboarding_notice_password_recommended: '선택 사항이지만 localhost 밖으로 UI를 노출할 경우 권장됩니다.',
	onboarding_password_label: '비밀번호(선택)',
	onboarding_password_placeholder: '건너뛰려면 비워 두세요',
	onboarding_password_help: '비밀번호는 기존 설정 API를 통해 저장되며 서버 측에서 해시됩니다.',
	onboarding_notice_finish: '나중에 설정을 다시 열어 언제든지 변경할 수 있습니다.',
	onboarding_not_set: '설정되지 않음',
	onboarding_password_will_enable: '활성화 예정',
	onboarding_password_will_replace: '교체 예정',
	onboarding_password_keep_existing: '현재 비밀번호 유지',
	onboarding_password_remains_disabled: '비활성 상태 유지',
	onboarding_password_skipped: '일단 건너뜀',
	onboarding_finish_help: '완료하면 설정에 `onboarding_completed`가 저장되고 일반 앱으로 이동합니다.',
	onboarding_error_choose_workspace: '계속하기 전에 워크스페이스를 선택하세요.',
	onboarding_error_choose_model: '계속하기 전에 모델을 선택하세요.',
	onboarding_error_provider_required: '계속하기 전에 설정 방식을 선택하세요.',
	onboarding_error_base_url_required: '사용자 지정 엔드포인트에는 Base URL이 필요합니다.',
	onboarding_probe_test_button: '연결 테스트',
	onboarding_probe_probing: '연결 테스트 중…',
	onboarding_probe_ok: '연결됨.\n{n}개 모델을 사용할 수 있습니다.',
	onboarding_probe_error_generic: '설정된 Base URL에 연결할 수 없습니다.',
	onboarding_probe_error_invalid_url: 'Base URL은 http:// 또는 https://로 시작해야 합니다.',
	onboarding_probe_error_dns: '호스트를 확인할 수 없습니다. URL을 확인하거나 호스트의 IP 주소를 사용하세요.',
	onboarding_probe_error_connect_refused: '연결이 거부되었습니다 — 해당 주소에서 서버가 실행 중이 아닐 수 있습니다.\nDocker 내부에서는 localhost 대신 호스트 IP를 사용해 보세요.',
	onboarding_probe_error_timeout: '엔드포인트가 제시간에 응답하지 않았습니다. 서버가 실행 중인지, URL이 올바른지 확인하세요.',
	onboarding_probe_error_http_4xx: '엔드포인트가 클라이언트 오류를 반환했습니다. 인증 정보와 URL 경로를 확인하세요. 보통 /v1로 끝납니다.',
	onboarding_probe_error_http_5xx: '엔드포인트가 서버 오류를 반환했습니다.\nLM Studio / Ollama 서버 로그를 확인하세요.',
	onboarding_probe_error_parse: '엔드포인트가 예상 형식의 모델 목록을 반환하지 않았습니다.\nURL이 OpenAI 호환 API 루트를 가리키는지 확인하세요.',
	onboarding_probe_error_unreachable: '설정된 Base URL에 연결할 수 없습니다.',
	onboarding_error_probe_failed: '설정된 Base URL을 검증할 수 없습니다.',
	onboarding_error_workspace_required: '워크스페이스는 필수입니다.',
	onboarding_error_model_required: '모델은 필수입니다.',
	...
	cron_schedule_placeholder: '스케줄',
	cron_prompt_placeholder: '프롬프트',
	cron_last_output: '마지막 출력',
	cron_all_runs: '전체 실행',
	cron_hide_runs: '실행 숨기기',
	cron_no_runs_yet: '(아직 실행 없음)',
	cron_schedule_required_example: '스케줄이 필요합니다. 예: "0 9 * * *" 또는 "every 1h"',
	cron_schedule_required: '스케줄은 필수입니다',
	cron_prompt_required: '프롬프트는 필수입니다',
	cron_job_created: '작업이 생성되었습니다',
	cron_duplicate: '복제',
	cron_duplicated: '작업이 복제되었습니다(일시 중지됨)',
	cron_job_triggered: '작업이 실행되었습니다',
	cron_job_paused: '작업이 일시 중지되었습니다',
	cron_job_resumed: '작업이 재개되었습니다',
	cron_job_updated: '작업이 업데이트되었습니다',
	cron_delete_confirm_title: 'cron 작업 삭제',
	cron_delete_confirm_message: '이 작업은 되돌릴 수 없습니다.',
	cron_job_deleted: '작업이 삭제되었습니다',
	cron_completion_status: (name, status) => `Cron "${name}" ${status}`,
	status_failed: '실패',
	status_completed: '완료',
	todos_no_active: '이 세션에는 활성 작업 목록이 없습니다.',
	clear_conversation_title: '대화 지우기',
	clear_conversation_message: '모든 메시지를 지울까요? 이 작업은 되돌릴 수 없습니다.',
	clear_failed: '지우기 실패: ',
	...
	skill_name_required: '스킬 이름은 필수입니다',
	skill_updated: '스킬이 업데이트되었습니다',
	skill_created: '스킬이 생성되었습니다',
	skill_deleted: '스킬이 삭제되었습니다',
	skill_delete_confirm: '스킬 "{0}"을(를) 삭제할까요?',
	skills_empty_title: '스킬 선택',
	skills_empty_sub: '내용을 보려면 사이드바에서 스킬을 선택하거나 새로 만드세요.',
	skills_edit: '편집',
	skills_delete: '삭제',
	skills_back_to: '{0}(으)로 돌아가기',
	tasks_empty_title: '예약 작업 선택',
	tasks_empty_sub: '자세한 내용과 실행 기록을 보려면 사이드바에서 작업을 선택하거나 새로 만드세요.',
	workspaces_empty_title: '스페이스 선택',
	workspaces_empty_sub: '파일과 설정을 보려면 사이드바에서 스페이스를 선택하거나 새로 추가하세요.',
	profiles_empty_title: '프로필 선택',
	profiles_empty_sub: '설정을 보고 편집하려면 사이드바에서 에이전트 프로필을 선택하거나 새로 만드세요.',
	memory_notes_label: '메모리(노트)',
	memory_saved: '메모리가 저장되었습니다',
	my_notes: '내 노트',
	user_profile: '사용자 프로필',
	no_notes_yet: '아직 노트가 없습니다.',
	no_profile_yet: '아직 프로필이 없습니다.',

	workspace_choose_path: '워크스페이스 경로 선택',
	workspace_choose_path_meta: '검증된 경로를 추가하고 이 대화를 전환합니다',
	workspace_manage: '워크스페이스 관리',
	workspace_manage_meta: '스페이스 패널 열기',
	workspace_use_title: '현재 세션에서 사용',
	workspace_use: '사용',
	workspace_add_path_placeholder: '워크스페이스 경로 추가(예: /home/user/my-project)',
	workspace_paths_validated_hint: '경로는 저장 전 실제 디렉터리인지 검증됩니다.',
	workspace_drag_hint: '드래그하여 순서 변경',
	workspace_reorder_failed: '순서 변경 실패',
	workspace_added: '워크스페이스가 추가되었습니다',
	workspace_renamed: '워크스페이스 이름이 변경되었습니다',
	workspace_remove_confirm_title: '워크스페이스 제거',
	workspace_remove_confirm_message: (path) => `"${path}"을(를) 제거할까요?`,
	workspace_removed: '워크스페이스가 제거되었습니다',
	workspace_switch_prompt_title: '워크스페이스 전환',
	workspace_switch_prompt_message: '추가하고 이 대화를 전환할 절대 워크스페이스 경로를 입력하세요.',
	workspace_switch_prompt_confirm: '전환',
	workspace_switch_prompt_placeholder: '/Users/you/project',
	workspace_not_added: '워크스페이스가 추가되지 않았습니다',
	workspace_already_saved: '이미 저장된 워크스페이스입니다 — 목록에서 선택하세요',
	workspace_busy_switch: '에이전트 실행 중에는 워크스페이스를 전환할 수 없습니다',
	discard_file_edits_title: '파일 편집 내용을 버릴까요?',
	discard_file_edits_message: '워크스페이스를 전환하면 미리보기의 저장되지 않은 파일 편집 내용이 사라집니다.',
	workspace_switched_to: (name) => `${name}(으)로 전환되었습니다`,

	profiles_no_profiles: '프로필을 찾을 수 없습니다.',
	profile_api_keys_configured: 'API 키 설정됨',
	profile_gateway_running: 'Gateway 실행 중',
	profile_gateway_stopped: 'Gateway 중지됨',
	profile_active: '활성',
	profile_no_configuration: '설정 없음',
	profile_skill_count: (count) => `${count}개 스킬`,
	profile_use: '사용',
	profile_switch_title: '이 프로필로 전환',
	profile_delete_title: '이 프로필 삭제',
	profile_default_label: '(기본값)',
	profile_name_placeholder: '프로필 이름(소문자, a-z, 0-9, 하이픈)',
	profile_clone_label: '활성 프로필에서 설정 복제',
	profile_base_url_placeholder: 'Base URL(선택, 예: http://localhost:11434)',
	profile_api_key_placeholder: 'API 키(선택)',
	manage_profiles: '프로필 관리',
	profiles_load_failed: '프로필을 불러오지 못했습니다',
	profile_switched_new_conversation: (name) => `프로필 전환됨: ${name} — 새 대화가 시작되었습니다`,
	profile_switched: (name) => `프로필 전환됨: ${name}`,
	profile_name_rule: '소문자, 숫자, 하이픈, 밑줄만 사용할 수 있습니다',
	profile_base_url_rule: 'Base URL은 http:// 또는 https://로 시작해야 합니다',
	profile_created: (name) => `프로필 생성됨: ${name}`,
	profile_delete_confirm_title: (name) => `프로필 "${name}"을(를) 삭제할까요?`,
	profile_delete_confirm_message: '이 프로필의 모든 세션, 설정, 스킬, 메모리가 영구 삭제됩니다.\n이 작업은 되돌릴 수 없습니다.',
	profile_deleted: (name) => `프로필 삭제됨: ${name}`,
	active_conversation_none: '선택된 활성 대화가 없습니다.',
	active_conversation_meta: (title, count) => `${title} · 메시지 ${count}개`,
	settings_unsaved_changes: '저장되지 않은 변경 사항이 있습니다.',
	...
	bg_error_single: (title) => `"${title}"에서 오류가 발생했습니다`,
	bg_error_multi: (count) => `${count}개 세션에서 오류가 발생했습니다`,

	// skill form
	skill_name: '이름',
	skill_category: '카테고리',
	skill_category_placeholder: '선택, 예: devops',
	skill_content: 'SKILL.md 내용',
	skill_content_placeholder: 'YAML frontmatter + markdown 본문',
	skill_rename_not_supported: '스킬 이름 변경은 지원되지 않습니다. 이름을 바꾸려면 새 스킬을 만들고 기존 스킬을 삭제하세요.',
	skill_metadata: '메타데이터',

	// cron form
	cron_name_label: '이름',
	cron_name_placeholder: '선택',
	cron_schedule_label: '스케줄',
	cron_schedule_hint: "'every 1h' 또는 cron 표현식을 사용해 반복 작업을 설정하세요.\n'30m' 같은 단독 기간은 한 번만 실행됩니다.",
	cron_schedule_once_warning: "'30m' 같은 기간 형식은 한 번 실행된 뒤 제거됩니다. 반복 작업으로 유지하려면 'every 30m'을 사용하세요.",
	cron_prompt_label: '프롬프트',
	cron_deliver_label: '출력 전달 위치',
	cron_deliver_local: '로컬(출력만 저장)',
	cron_profile_label: '프로필',
	cron_profile_server_default: '서버 기본값',
	cron_profile_server_default_hint: '실행 시점의 WebUI 서버 기본 프로필을 사용합니다.\n프로필이 없는 기존 작업은 이 레거시 동작을 유지합니다.',
	cron_skills_label: '스킬',
	cron_skills_placeholder: '스킬 추가(선택)…',
	cron_skills_edit_hint: '스킬 목록은 생성 후 편집할 수 없습니다.',

	// workspace form
	workspace_name_label: '이름',
	workspace_name_placeholder: '선택 가능한 표시 이름',
	workspace_path_label: '경로',
	workspace_path_required: '경로는 필수입니다',
	workspace_path_readonly: '경로는 변경할 수 없습니다.\n이름만 바꿀 수 있습니다.',
	workspace_new_title: '새 스페이스',

	// profile form
	profile_name_label: '이름',
	profile_base_url_label: 'Base URL',
	profile_api_key_label: 'API 키',

	cmd_yolo: 'YOLO 모드 전환',
	cmd_branch: '이 대화를 새 세션으로 분기',
	cmd_branch_usage: '/branch [name] — 대화 분기(이름 선택 가능)',
	branch_forked: '새 세션으로 분기되었습니다',
	branch_failed: '분기 실패: ',
	fork_from_here: '여기에서 분기',
	forked_from: '다음에서 분기됨',
	...
	pdf_no_pages: 'PDF에 페이지가 없습니다',
	pdf_error: 'PDF 미리보기 렌더링 실패',
	...
	excalidraw_simplified: '단순화된 SVG 미리보기 — Excalidraw 캔버스와 픽셀 단위로 일치하지 않을 수 있음',

	// TTS
	tts_listen: '듣기',
	tts_not_supported: '이 브라우저에서는 음성 합성을 사용할 수 없습니다.',
	settings_label_tts: '답변 음성 합성',
	settings_desc_tts: '각 Assistant 메시지에 스피커 버튼을 표시해 브라우저 음성 합성으로 읽어줍니다.',
	settings_label_tts_auto_read: '답변 자동 읽기',
	settings_desc_tts_auto_read: '새 Assistant 응답이 완료되면 자동으로 소리 내어 읽습니다.\n입력을 시작하면 일시 중지됩니다.',

	// Composer voice-mode pref
	settings_label_voice_mode: '핸즈프리 음성 모드 버튼',
	settings_desc_voice_mode: '받아쓰기 마이크 옆에 음성 모드 버튼(오디오 파형)을 표시합니다.\n자연스럽게 말하면 Hermes가 잠시 후 자동으로 전송하고 답변을 음성으로 읽어줍니다.\n음성 인식과 TTS를 모두 지원하는 브라우저가 필요합니다.',
	settings_label_tts_voice: '음성',
	settings_desc_tts_voice: '선호 음성입니다. 브라우저에서 사용 가능한 음성 목록으로 채워집니다.',
	settings_label_tts_rate: '말 속도',
	settings_label_tts_pitch: '말 톤',

	checkpoint_date: '날짜',
	checkpoint_diff_files_changed: (n) => `${n}개 파일 변경됨`,
	checkpoint_diff_no_changes: '이 체크포인트와 현재 워크스페이스 사이에 차이가 없습니다.',
	checkpoint_diff_title: '체크포인트 변경 사항',
	checkpoint_empty: '이 워크스페이스에는 체크포인트가 없습니다.',
	checkpoint_error: '체크포인트를 불러오지 못했습니다',
	checkpoint_files: '파일',
	checkpoint_loading: '체크포인트 불러오는 중…',
	checkpoint_message: '메시지',
	checkpoint_restore: '복원',
	checkpoint_restore_confirm_message: (ckpt) => `워크스페이스를 체크포인트 "${ckpt}" 상태로 복원할까요? 저장된 버전으로 파일을 덮어씁니다.\n이 체크포인트 이후 추가된 파일은 삭제되지 않습니다.`,
	checkpoint_restore_confirm_title: '체크포인트를 복원할까요?',
	checkpoint_restored: '체크포인트가 복원되었습니다',
	checkpoint_title: '체크포인트',
	checkpoint_view_diff: '차이 보기',

	insights_activity_by_day: '일별 활동',
	insights_activity_by_hour: '시간대별 활동',
	insights_cost: '예상 비용',
	...
	insights_footer: '최근 {days}일 데이터 표시 중',
	...
	settings_desc_api_redact: '셀프호스팅 사용자는 투명성을 위해 비활성화할 수 있습니다. 공유 인스턴스에서는 권장되지 않습니다.',
	settings_label_api_redact: 'API 응답의 민감정보 마스킹',

	voice_error: '이 브라우저에서는 음성을 지원하지 않습니다',
	...
	// Composer voice buttons
	voice_dictate: '받아쓰기',
	voice_dictate_active: '받아쓰기 중지',
